...
.hai{
    width: 100%;
background: linear-gradient(to top, rgba(0,0,0,0) 50%, rgba(0,0,0,0) 50%), url("../images/main.png");
...
<div class="hai">
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                    <li><a href="adminequip.php">VEHICLE MANAGEMENT</a></li>
        ...
        <div>
            ...
            <div>
                ...
                <tr  class="active-row">
                    ...
                    <td><button type="submit" class="but" name="approve"><a href="adminreturn.php?id=<?php echo $res['EQUIP_ID']?>&bookid=<?php echo $res['BOOK_ID']?>">RETURNED</a></button></td>
                </tr>
               <?php } ?>
                </tbody>
                </table>
