...
body{
    ...
    background-size: 100%; /* Set the length to 60% */
    margin:center; /* Prevent the image from repeating */
...
<?php 
    ...
    $sql2="select * from Equipmentdetails where AVAILABLE='Y'";
    $Equipments= mysqli_query($con,$sql2);
        ...
        <div class="navbar">
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><p class="phello">&nbsp;<a id="pname"><?php
                    if ($rows !== null) {
                    echo "HELLO! &nbsp;<a id='pname'>{$rows['FNAME']} {$rows['LNAME']}</a>";
                    } else {
                    // Handle case when $rows is null (e.g., display default message or redirect user)
                    echo "HELLO! User data not found.";
                    }
?>
</a></p></li>
      ...
      <div><h1 class="overview">OUR APPARATUS OVERVIEW</h1>

    <ul class="de">
    <?php
        while($result= mysqli_fetch_array($Equipments))
        {
            echo $result['EQUIP_ID'];
    ...
    <div class="box">
       <div class="imgBx">
            <img src="images/<?php echo $result['EQUIP_IMG']?>">
        </div>
        <div class="content">
            <?php $res=$result['EQUIP_ID'];?>
            <h1><?php echo $result['EQUIP_NAME']?></h1>
