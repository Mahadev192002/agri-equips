...
<button class="btn" style="
                        ...
                        margin-left:100px;
						margin-top:25px;
                    "><a href="Equipmentdetails.php" style="
                    text-decoration: none;
                    color: #0B6623;">Go To Home</a></button><button id="back">
...
<br><br><br>
	<div id="form">	
		...
		<div class="col-md-12" id ="mainform">
			<div class="col-sm-6">
			   <h2  class="contact-us" style="font-size:72px; color:#808080;"><strong style="font-size:5cm; color:#455859;">F</strong>eedback.</h2>
			</div>
			<div class="col-sm-6" >
				<form method="POST">
